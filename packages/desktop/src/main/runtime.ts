...
import { SavedPromptsServiceLive } from "./services/SavedPromptsService"
...
const SavedPromptsLayer = SavedPromptsServiceLive.pipe(Layer.provide(NodeFileSystem.layer))
